...
def validation_run(env, net, episode = 100, device = "cpu", epsilon = 0.02, comission = 0.1):
    stats = {'episode_reward': [], 'episode_steps': [], 'order_profits': [], 'order_steps': [],}
    for episode in range(episodes):
        ...
        while True:
            ...
            if action == environ.Actions.Buy and position is None:
                ...
                stats['order_profits'].append(profits)
